...
LOCAL_FILE="/home/femu/ecwide-ssd/test/chunks/D_1_0"
REMOTE_USER="femu"
REMOTE_HOST="node01"
REMOTE_PATH="/mnt/nvme0/D_1_0"

while true; do
  # 当前时间戳
  TIMESTAMP=$(date +%Y%m%d%H%M%S)

  echo "[*] Updating file D_1_0 at $TIMESTAMP..."
  ...
  rsync -azP "$LOCAL_FILE" "$REMOTE_USER@$REMOTE_HOST:$REMOTE_PATH"
